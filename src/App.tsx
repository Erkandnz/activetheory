...
import ParticleLogoMorph from './ParticleLogoMorph';
...
export default function App() {
  ...
  // Orijinal Active Theory bundle'ına hiç dokunmadan, üstüne bağımsız
  // bir katman olarak eklenen kendi "parçacık -> E logosu" efektiniz.
  return <ParticleLogoMorph />;
}
